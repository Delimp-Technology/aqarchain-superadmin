...
import {getAgentsList} from '../../../redux/actions/Agents';
          ...
          <div className="col-lg-12">
            <div
              ...
              <div
                ...
                id="superadmin-nav-tab-agents"
                role="tabpanel"
                aria-labelledby="superadmin-nav-tab-agents-tab">
                <div className="text-center text-lg-left p-4 p-lg-5 has-box-shadow">
                  <div className="row d-lg-flex align-items-center">
                    <div className="col-xl-6 col-lg-4">
                      <h2 className="font-weight-bold mb-3 mb-lg-4">Agents</h2>
                    </div>
...
export default IsLoadingHOC(Agents);
